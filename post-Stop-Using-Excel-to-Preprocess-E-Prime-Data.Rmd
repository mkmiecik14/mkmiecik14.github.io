...
For the purposes of this tutorial, these data are available on my blog-materials github repository and can be downloaded into R like this:

```{r import2}
rm(list = ls())                 # Clears workspace
library(RCurl)                  # To retrive data from github repo
eData <- read.table(text = getURL("https://raw.githubusercontent.com/mkmiecik14/blog-materials/master/data.txt"), 
                   sep = '\t',
                   header = T)
dim(eData)
```
...
this.page.url = 'https://mkmiecik14.github.io/post-Stop-Using-Excel-to-Preprocess-E-Prime-Data.html';  // Replace PAGE_URL with your page's canonical URL variable
