...
For the purposes of this tutorial, these data are available on this websites github repository and can be downloaded into R like this:

```{r import2}
rm(list = ls())                 # Clears workspace
library(RCurl)                  # To retrive data from github repo
eData <- read.table(text = getURL("https://mkmiecik14.github.io/data/data.txt"), 
                   sep = '\t',
                   header = T)
dim(eData)
```
