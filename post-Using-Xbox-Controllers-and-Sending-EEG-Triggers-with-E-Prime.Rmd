...
I've programmed a simple experiment that checks the passing of triggers to a local EEG system that is available for download on this websites' githup repo. See [here]() to download the experiment file titled *triggerTutorialExperiment.es2*.
