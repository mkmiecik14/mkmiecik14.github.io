...
I've programmed a simple experiment that checks the passing of triggers to a local EEG system that is available for download on [my blog-materials github repo](https://github.com/mkmiecik14/blog-materials). Click [here](https://raw.githubusercontent.com/mkmiecik14/blog-materials/master/triggerTutorialExperiment.es2) to download the experiment file titled **triggerTutorialExperiment.es2**.
