...
I've programmed a simple experiment that checks the passing of triggers to a local EEG system that is available for download on [this websites' github repo](https://github.com/mkmiecik14/mkmiecik14.github.io/tree/master/data). Click [here](mkmiecik14.github.io/data/triggerTutorialExperiment.es2) to download the experiment file titled **triggerTutorialExperiment.es2**.
