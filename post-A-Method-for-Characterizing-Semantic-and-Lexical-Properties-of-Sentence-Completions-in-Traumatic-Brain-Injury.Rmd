...
```{r exTable}
library(tidyverse)
example.table <- tibble(Section = c(1,2),
                        Completion = c('Sensible', 'Unconnected'),
                        `Sentence Stem` = c('He mailed a letter without a',
...
this.page.url = 'https://mattkmiecik.com/post-A-Method-for-Characterizing-Semantic-and-Lexical-Properties-of-Sentence-Completions-in-Traumatic-Brain-Injury.html';  // Replace PAGE_URL with your page's canonical URL variable
this.page.identifier = 'post-A-Method-for-Characterizing-Semantic-and-Lexical-Properties-of-Sentence-Completions-in-Traumatic-Brain-Injury'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
};
*/
