...
# Step 1: Load data
data5v4 <- read.table(text = getURL("https://mkmiecik14.github.io/data/corsicaData_5v4.csv"),
                      sep = ',',
                      header = T)
...
ggplot(bestPP, aes(mean, reorder(Team, mean), colour = sig)) +
  ...
  scale_color_brewer(palette = 'Set1', 
                     ...
                     guide = guide_legend(reverse = T,
                                          ...
                                          title.position = 'top')) +
  xlab('Mean Power Play Goals/Games Played (Residuals)') +
  ylab('NHL Team') +
...
2) Top power play teams are the Washington Capitals, Philadelphia Flyers, Detroit Red Wings, and the San Jose Sharks, and Pittsburgh Penguins
3) Worst power play teams are New York Islanders, Phoenix Coyotes, Nashville Predators, New York Rangers, New Jersey Devils, Colorado Avalanche, and Florida Panthers  
