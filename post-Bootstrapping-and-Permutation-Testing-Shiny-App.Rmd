...
This post serves as a brief overview of the difference between boostrapping and permutation testing with a shiny app to visualize their differences. The example we use is correlation; however, these techniques can be extended to a variety of statistics (e.g., t-test, ANOVA, PCA).
...
_Note:_ If the app does not appear, it may have reached the 25 active hours per month allotted to [shinyapps.io](https://www.shinyapps.io/) free users (me!). In that case, see the code below to run it locally on your machine.
