...
Here's the shiny app used to illustrate these concepts. [Click here to see the app in full screen.](https://ec2-18-188-158-248.us-east-2.compute.amazonaws.com/)

```{r}
knitr::include_app("https://ec2-18-188-158-248.us-east-2.compute.amazonaws.com/", 
                   height = "1400px")
```

<p class="text-info">_Note:_ We are now hosting this app on Amazon’s EC2 cloud service. Please feel free to email me (matthew.kmiecik@utdallas.edu) if the app is down. Thanks!</p>
