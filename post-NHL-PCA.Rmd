...
Briefly, U contains information about the rows (e.g., years), V contains information about the columns (e.g., measures), and \Delta is a diagonal matrix of "weights" called singular values that are the square root of the eigen values.
...
nice_table(round(scree, 2)) # prints HTML table
